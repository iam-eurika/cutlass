...
pub use audio::{
    AUDIO_CHANNELS, AudioPeaks, AudioReader, CONTROL_HZ, DuckSettings, audio_peaks,
    audio_peaks_per_second, duck_gain, reduce_curve, render_stretched, render_stretched_curve,
    speech_band_energy,
};
